...
const App: React.FC = () => {
  ...
  // 临时的GraphViewer组件，用于测试SplitPaneContainer
  const GraphViewer = () => (
    <div className="bg-white/90 backdrop-blur shadow-sm border border-slate-200 h-full overflow-auto">
      <div className="p-4">
        <h3 className="text-lg font-semibold text-slate-800 mb-4">Graph Viewer</h3>
        <div className="text-sm text-slate-600">
          <p>This is a placeholder for the Graph Viewer component.</p>
          <p>It will display Neo4j graph visualizations.</p>
        </div>
      </div>
    </div>
  );
    ...
    <LayoutStateProvider>
      <div className="flex flex-col h-screen bg-slate-50 overflow-hidden">
        ...
        <main className="flex-1 flex overflow-hidden">
          {/* Left Side: Split Pane with Model & Graph */}
